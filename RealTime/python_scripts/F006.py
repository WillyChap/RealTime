...
stepnum=2
years_back = 2
input_nc_file= root_loc+'regrid_folder/IVT_ERAGrid_F006.nc'
norm_file = root_loc+'python_scripts/models/F006/norm_dict.npy'
outputfile =root_loc+'output_forecast/pp_F006.nc'
Wsave_name= root_loc+'python_scripts/models/F006/cpf_CRPS_val_2016_test_2017.ckpt'
